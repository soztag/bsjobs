...
**Entwurf**: Folgendes ist ziemlich lose gewirkt.
</div>

@GraeberBullshitJobsTheory2018 operationalisiert "Bullshit Jobs" als *subjektives* Konzept, also ausgehend von der Selbsteinschätzung der sozialen Nützlichkeit der eigenen Arbeit.

Zudem kann "Bullshit Jobs" als Moralkritik unserer Wirtschaftsweise verstanden werden.
"Bullshit Jobs" wäre dann kein a posteriori positiver Befund über die *Verbreitung* von vermeintlich "unnützer" oder "schädlicher" Arbeit, sondern --- wohlwollend gelesen --- ein axiomatischer Geltungsanspruch zu *guter* Arbeit.
Gute Arbeit wäre dann subjektiv als anderen Menschen dienlich empfundene Arbeit.

Graeber reisst die Probleme dieser augenscheinlich paradoxen Definition --- *subjektiv* anderen *nützliche* Arbeit --- an, kann sie aber nicht abschließend lösen.
Zwischen den gleichermaßen tautologischen "Nutzen"definition der Neoklassik einerseits (Nutzen als Zahlungsbereitschaft) und des Marxismus andererseits (Gebrauchswert als situativ und qualitativ), kann Graebers hemdsärmliche Operationalisierung aber als erfrischend pragmatischer Versuch gelten.

*Wenn* die Kritik der Bullshit Jobs Menschen treffend erscheint, um über ihre und die Arbeit anderer zu reflektieren, dann kann sie zumindest *möglicherwiese* im Sinne eines "*ökologischen*" (engl. "ecological") Pragmatismus gelten [vgl. @Peirce-1903].
In James' prägnanter Formulierung haben Bullshit Jobs den "Barwert ihrer Wahrheit" [-@JamesPragmatismNewName1907: 200] eingelöst, wenn sie Menschen befähigen, *alternative* und *gangbare* wirtschaftliche Arrangements zu fordern.
Bullshit Jobs --- erneut wohlwollend gelesen --- könnten dann als charakteristisch kontingente, vorläufige und *erstrebende* Forderung eines amerikanischen Pragmatismus verstanden werden [vgl. @Dewey-1916].
Im Unterschied zum (lose gesprochenen) Marxismus, sind Bullshit Jobs nicht "entfremdend" [@Marx-1867-aa], da sie einem *konstanten* menschlichen Gattungswesen widersprechen [vgl. @HaugDoppelcharakterArbeit], oder weil sie einem angenommenen, abschließend menschengerechten Arrangement widersprechen, sondern weil sie vor dem *konkreten*, gegenwärtigen Hintergrund technologischer und organisationeller Innovation als unnütz erkannt werden können. 
Ebenso wären Bullshit Jobs nicht schlicht eine (mutmaßlich durch staatliche Verzerrung verursachte) Abweichung von kompetitiven Märkten, oder definitorische Unmöglichkeiten (da nicht Pareto-verbessernd) einer katallaktischen Ordnung [@Hayek-1960], wie aus neoklassischer oder libertärer Sicht argumentiert werden könnte.
Sie blieben trotz und unabhängig von ihrer gegenwärtigen ökonomischen Rationalität irrsinnig, da es subjektiv nützlichere Tätigkeiten gibt, und das Preissystem damit seiner vermittelnden Aufgabe offenkundig nicht nachkommt.
...
Aus zweierlei Sicht ist es sinnvoll, öffentliche Reaktionen auf Graebers "Bullshit Jobs" näher zu untersuchen.

1. Zum einen erfordert Graeber subjektive Operationalisierung von Bullshit Jobs weitere Untermauerung.
     Graebers selbst vorgetragene Empirie ist überwiegend anektodisch, eklatant selbst-selektiert (Korrespondenz *an* den Autor) und sowohl qualitativ als auch quantitativ dünn.
    Sollten tatsächlich viele Menschen ihre Arbeit als nutzlos empfinden, dann sollte sich dies in öffentlichen Reaktionen niederschlagen, jedenfalls wenn Anonymitität gewährleistet ist.
    Da auch die Definition von Bullshit Jobs lückenhaft ist, ist auch von Interesse *welche Qualitäten* Arbeit nutzlos erscheinen lassen.
2. Auch der ökologisch-pragmatische *Nutzen* sollte sich in öffentlichen Reaktionen niederschlagen.
     Zwar kann eine Moralkritik nicht a posteriori positiv überprüft werden, im pragmatischen Sinne sollte sie aber nach einiger Erläuterung [wie in @GraeberBullshitJobsTheory2018] Menschen dienlich sein, alternative Arrangements zu fordern.
...
- Zwar sind alle Einreichungen zum Thema Bullshit Jobs, allerdings sind die entsprechenden Links zumeist *nicht* das tatsächliche Buch, sondern zu Besprechungen, hier vor allem zu einem entsprechenden Artikel auf [wired.co.uk](https://www.wired.co.uk/article/bullshit-jobs-david-graeber-review) [@UpchurchForgetfearsautomation2018].
...
- Der Artikel behandelt zwar mehrere Aspekte des Buches, die Überschrift ("Forget fears of automation, your job is probably bullshit anyway") und Schlussfolgerung verengt die Thesen Buches jedoch auf technologischen Wandel und den Vorschlag eines bedingungslosen Grundeinkommens ("universal basic income", UBI).
  Viele der Kommentare beschäftigen sich dann auch eher mit diesen Themen, als einer breiteren Auseinandersetzung mit den "bullshit jobs".
...
<div class="alert alert-warning">
**Entwurf**: Die folgende Analyse ist stark kursorisch und vorläufig!
</div>
...
td_coms <- td_coms %>% 
  mutate(word = textstem::lemmatize_strings(x = word, dictionary = dict))
...
Aus der kursorischen Betrachtung einiger Kommentare ergibt sich, das Automatisierung hier keinesfalls nur, oder überwiegend als Bedrohung betrachtet wird, sondern durchaus als "Bullshit"-befreiende Technologien.
